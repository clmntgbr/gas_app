...
class BottomBarView extends StatefulWidget {
  ...
  final List<MenuData>? tabIconsList;
...
class BottomBarViewState extends State<BottomBarView> with TickerProviderStateMixin {
                  ...
                  child: ScaleTransition(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: <BoxShadow>[
                          BoxShadow(color: const Color(0xFF2633C5).withOpacity(0.4), offset: const Offset(8.0, 16.0), blurRadius: 16.0),
                        ],
                      ),
                      child: Material(
                        color: Colors.transparent,
  ...
  void setRemoveAllSelection(MenuData? tabIconData) {
    if (!mounted) return;
    setState(() {
      widget.tabIconsList?.forEach((MenuData tab) {
